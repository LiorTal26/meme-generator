...
function createImgs() {
    createImg(gNextId++, ["funny", "bad"], 60, "./img/1.jpg");
    createImg(gNextId++, "cute", 60, "./img/2.jpg");
    createImg(gNextId++, "cute", 60, "./img/3.jpg");
    createImg(gNextId++, "cute", 60, "./img/4.jpg");
    createImg(gNextId++, "funny", 60, "./img/5.jpg");
    createImg(gNextId++, "funny", 60, "./img/6.jpg");
    createImg(gNextId++, "funny", 60, "./img/7.jpg");
    createImg(gNextId++, "happy", 60, "./img/8.jpg");
    createImg(gNextId++, "funny", 60, "./img/9.jpg");
    createImg(gNextId++, "funny", 60, "./img/10.jpg");
    createImg(gNextId++, "happy", 60, "./img/11.jpg");
    createImg(gNextId++, "happy", 60, "./img/12.jpg");
    createImg(gNextId++, "bad", 60, "./img/13.jpg");
    createImg(gNextId++, "bad", 60, "./img/14.jpg");
    createImg(gNextId++, "bad", 60, "./img/15.jpg");
    createImg(gNextId++, "funny", 60, "./img/16.jpg");
    createImg(gNextId++, "bad", 60, "./img/17.jpg");
    createImg(gNextId++, "bad", 60, "./img/18.jpg");
}
